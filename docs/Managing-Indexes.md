...
![Administration dashboard highlight the Search application](/images/xperience-administration-dashboard.png)

Create a new index or select and index to edit by clicking the index row.

![Administration search index list](/images/xperience-administration-search-index-list.png)
...
- Index Name - Index Name - the name of the displayed index.
...
- Indexing Strategy - the indexing strategy specified in code during dependency registration of a custom indexing strategies.
  - If you want the default strategy to appear here, register it explicitly in `IServiceCollection.AddKenticoElasticSearch()` method
...
![Administration search edit paths form](/images/xperience-administration-search-index-edit-form-paths-edit.png)
